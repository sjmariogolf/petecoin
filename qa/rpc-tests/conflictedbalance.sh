...
# Copyright (c) 2014 The Petecoin Core developers
...
# B1 should still be able to spend 1000000 (-1 PETE fee for the successful transaction), because D is conflicted
