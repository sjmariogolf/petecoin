...
// Copyright (c) 2013-2014 The Petecoin developers
...
public:
    CMainParams() {
        ...
        //   vMerkleTree: 4a5e1e
        const char* pszTimestamp = "Pete's the dog.";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        genesis.nVersion = 1;
        genesis.nTime    = 1425034810;
        genesis.nBits    = 0x1e0ffff0;
        genesis.nNonce   = 839219;

/*
genesis.nTime = 1425034810 
genesis.nNonce = 839219 
genesis.GetHash = 3f2615abae55e4d261fd573155150f662009f42a59b22187013b704c796db722
petecoind: chainparams.cpp:187: CMainParams::CMainParams(): Assertion `hashGenesisBlock == uint256("0xd5ed2da5138abbb1e2328c59a2506b7fe9d847f3489eb6b70bae749fb67856df")' failed.
*/
...
*/
        ...
        assert(hashGenesisBlock == uint256("0x3f2615abae55e4d261fd573155150f662009f42a59b22187013b704c796db722"));
        assert(genesis.hashMerkleRoot == uint256("0x9b76d14ced5d064fa4ba6919bc0f3d40e693295f7f56d20053b458c590191163"));

        vSeeds.push_back(CDNSSeedData("petecoin.com", "seed.petecoin.com"));
        ...
        vSeeds.push_back(CDNSSeedData("petechain.info", "seed.petechain.info"));

        // Workaround for Boost not being quite compatible with C++11;
        std::vector<unsigned char> pka = list_of(55);
...
public:
    CTestNetParams() {
        ...
        genesis.nTime = 1419571204;
        genesis.nNonce = 1175608;
        hashGenesisBlock = genesis.GetHash();
/*
genesis.nTime = 1419571204 
genesis.nNonce = 1175608 
genesis.GetHash = 84b12b353384ec65e9162f88664861ce5e0bdaa3b686c246009e4622c26940ec
*/
...
//END
*/
        assert(hashGenesisBlock == uint256("0x84b12b353384ec65e9162f88664861ce5e0bdaa3b686c246009e4622c26940ec"));

        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("testpete.lionservers.de", "testpete-seed.lionservers.de"));
        vSeeds.push_back(CDNSSeedData("lionservers.de", "testpetpeteed-static.lionservers.de"));
