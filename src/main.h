...
static const int COINBASE_MATURITY_NEW = 10*4;
...
inline bool AllowFree(double dPriority)
{
    ...
    // need a fee.
        return dPriority > 100 * COIN * 1440 / 250; // Petecoin: 1440 blocks found a day. Priority cutoff is 100 petecoin day / 250 bytes.
    }
 ...
 */
// Petecoin specific implementation, standardizes checks for the hard maturity change at block 145k
