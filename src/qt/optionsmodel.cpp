...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::PETE);
    nDisplayUnit = settings.value("nDisplayUnit").toInt();
    if(!BitcoinUnits::valid(nDisplayUnit))
        nDisplayUnit = BitcoinUnits::PETE;
    ...
    if (!settings.contains("strThirdPartyTxUrls"))
        settings.setValue("strThirdPartyTxUrls", "https://petechain.info/tx/%s|https://chain.so/tx/PETE/%s");
