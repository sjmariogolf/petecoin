...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(MPETE);
    unitlist.append(kPETE);
    unitlist.append(PETE);
...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case MPETE: return QString("MPETE");
    case kPETE: return QString("kPETE");
    case PETE: return QString("PETE");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case MPETE: return QString("Mega-Petecoin (1,000,000 PETE)");
    case kPETE: return QString("Kilo-Petecoin (1000 PETE)");
    case PETE: return QString("Petecoin");
...
qint64 BitcoinUnits::factor(int unit)
{
    switch(unit)
    {
    case MPETE: return Q_INT64_C(100000000000000);
    case kPETE: return Q_INT64_C(100000000000);
    case PETE:  return Q_INT64_C(100000000);
...
qint64 BitcoinUnits::maxAmount(int unit)
{
    switch(unit)
    {
    case MPETE: return Q_INT64_C(900000);
    case kPETE: return Q_INT64_C(900000000);
    case PETE:  return Q_INT64_C(900000000000);    //less than the coin supply until the year 2170
...
int BitcoinUnits::amountDigits(int unit)
{
    switch(unit)
    {
    case MPETE: return 6;  // 900,000 (# digits, without commas)
    case kPETE: return 9;  // 900,000,000
    case PETE:  return 12; // 900,000,000,000
...
int BitcoinUnits::decimals(int unit)
{
    switch(unit)
    {
    case MPETE: return 14;
    case kPETE: return 11;
    case PETE: return 8;
    case Koinu: return 0;
    default: return 0;
    }
